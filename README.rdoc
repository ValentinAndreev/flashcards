...
* Other gems:
gem 'dotenv-rails', require: 'dotenv/rails-now', gem 'aws-sdk', gem "paperclip", gem 'sorcery', gem 'nokogiri', gem 'simple_form', gem 'pg', gem 'levenshtein-c', gem 'whenever', gem 'http_accept_language', gem "letter_opener" etc.
* Testing with:
