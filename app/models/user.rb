class User < ActiveRecord::Base
  ...
  def selectcard(pack_id = nil)
    if (pack_id && review_pack && (pack_id != review_pack.id) && get_card(pack_id)) || (pack_id && !review_pack && get_card(pack_id))
      [get_card(pack_id) , I18n.t(:Training_with_choosen_pack)]
