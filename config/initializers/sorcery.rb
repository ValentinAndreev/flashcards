...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.key = "3Lq2IXK6tVTUQjjSQkZRP0fmf"
  config.twitter.secret = "PSuzaDqLrnYzpzkg0GNncPx9nB8ec97KSsY6GTKAKyGIzJXgEX"
  config.twitter.callback_url = "http://127.0.0.1:3000/"
